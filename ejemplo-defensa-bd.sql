...
CREATE ROLE ROL_VENDEDOR_TICKETS;

--ROL CURADOR
GRANT EXECUTE ON SP_MOVER_OBRA TO ROL_CURADOR;
GRANT EXECUTE ON SP_REGISTRAR_MANTENIMIENTO_OBRA TO ROL_CURADOR;
...
GRANT SELECT ON ARTISTAS, COLECCIONES_PERMANENTES, SALAS_EXP TO ROL_CURADOR;
...
GRANT EXECUTE ON SP_INSERTAR_COLECCION TO ROL_ADMIN_MUSEO;
GRANT EXECUTE ON SP_MODIFICAR_ORDEN_COLECCION TO ROL_ADMIN_MUSEO;
GRANT EXECUTE ON SP_ELIMINAR_COLECCION TO ROL_ADMIN_MUSEO;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON COLECCIONES_PERMANENTES TO ROL_ADMIN_MUSEO;


-- El analista financiero solo puede EJECUTAR las funciones de cálculo.
GRANT EXECUTE ON FN_CALCULAR_INGRESOS_ANUALES_TOTALES TO ROL_ANALISTA_FINANCIERO;
GRANT EXECUTE ON FN_INGRESOS_ANUALES_TICKETS TO ROL_ANALISTA_FINANCIERO;
GRANT EXECUTE ON FN_INGRESOS_ANUALES_EVENTOS TO ROL_ANALISTA_FINANCIERO;
-- También necesita permiso para ver la tabla de museos.
GRANT SELECT ON MUSEOS TO ROL_ANALISTA_FINANCIERO;

-- El vendedor de tickets solo puede EJECUTAR el procedimiento para vender.
GRANT EXECUTE ON SP_VENDER_TICKET TO ROL_VENDEDOR_TICKETS;
