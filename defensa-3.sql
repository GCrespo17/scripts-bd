...
CREATE ROLE ROL_MANT_VIGILANTE;
...
GRANT EXECUTE ON SP_MOSTRAR_TURNOS_ACTUALES TO ROL_MANT_VIGILANTE;
-- Permisos SELECT para consultas de seguridad y turnos
GRANT SELECT ON ASIGNACIONES_MES TO ROL_MANT_VIGILANTE;
GRANT SELECT ON EMPLEADOS_VIGILANTE_MANT TO ROL_MANT_VIGILANTE;
GRANT SELECT ON EST_FISICA TO ROL_MANT_VIGILANTE;
GRANT SELECT ON SALAS_EXP TO ROL_MANT_VIGILANTE;
GRANT SELECT ON CIERRES_TEMPORALES TO ROL_MANT_VIGILANTE;
...
GRANT SELECT ON HIST_EMPLEADOS TO ROL_CURADOR;
GRANT SELECT ON FORMACIONES TO ROL_CURADOR;
GRANT SELECT ON EMPLEADOS_PROFESIONALES TO ROL_CURADOR;
-- Vistas de acceso seguro
...
GRANT SELECT ON EMPLEADOS_PROFESIONALES TO ROL_ADMIN_MUSEO;
...
-- ========================================
-- 2.3.1: OTORGAMIENTO DE PERMISOS DML (INSERT, UPDATE, DELETE)
-- ========================================

-- ROL ADMINISTRADOR
GRANT INSERT ON EMPLEADOS_PROFESIONALES TO ROL_ADMIN_MUSEO;
GRANT INSERT, UPDATE ON HIST_EMPLEADOS TO ROL_ADMIN_MUSEO;

-- ROL CURADOR
GRANT INSERT, UPDATE ON OBRAS TO ROL_CURADOR;
GRANT INSERT, UPDATE ON HIST_OBRAS_MOV TO ROL_CURADOR;
GRANT INSERT ON PROGRAMAS_MANT TO ROL_CURADOR;
GRANT UPDATE ON EXPOSICIONES_EVENTOS TO ROL_CURADOR;
GRANT INSERT, UPDATE, DELETE ON COLECCIONES_PERMANENTES TO ROL_CURADOR;

-- ROL RESTAURADOR
GRANT INSERT ON MANTENIMIENTOS_OBRAS_REALIZADOS TO ROL_RESTAURADOR;
...
GRANT ROL_MANT_VIGILANTE TO vigilante01;
...
GRANT SELECT ON FORMACIONES TO director01;
